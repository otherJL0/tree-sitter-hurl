...
static const TSParseActionEntry ts_parse_actions[] = {
  ...
  [25] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_request_section, 4),
  [27] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_request_section, 4),
  ...
  [35] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_request, 4),
  ...
  [41] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_request_repeat1, 2), SHIFT_REPEAT(23),
  [44] = {.entry = {.count = 2, .reusable = false}}, REDUCE(aux_sym_request_repeat1, 2), SHIFT_REPEAT(21),
  [47] = {.entry = {.count = 2, .reusable = false}}, REDUCE(aux_sym_request_repeat1, 2), SHIFT_REPEAT(6),
  [50] = {.entry = {.count = 1, .reusable = true}}, REDUCE(aux_sym_request_repeat2, 2),
  [52] = {.entry = {.count = 1, .reusable = false}}, REDUCE(aux_sym_request_repeat2, 2),
  [54] = {.entry = {.count = 2, .reusable = false}}, REDUCE(aux_sym_request_repeat2, 2), SHIFT_REPEAT(27),
  [57] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_request_section, 5),
  [59] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_request_section, 5),
  ...
  [65] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_source_file_repeat1, 2), SHIFT_REPEAT(26),
  [68] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym__lt, 2),
  [70] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym__lt, 2),
  [72] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym__lt, 3),
  [74] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym__lt, 3),
  [76] = {.entry = {.count = 1, .reusable = true}}, REDUCE(aux_sym_request_repeat3, 2),
  [78] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_request_repeat3, 2), SHIFT_REPEAT(18),
  [81] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_request, 5),
  ...
  [93] = {.entry = {.count = 1, .reusable = true}}, REDUCE(aux_sym__lt_repeat1, 2),
  [95] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym__lt_repeat1, 2), SHIFT_REPEAT(20),
  [98] = {.entry = {.count = 1, .reusable = false}}, REDUCE(aux_sym__lt_repeat1, 2),
  ...
  [112] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_method, 1),
